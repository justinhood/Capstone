...
\bibitem{DiscretePharm} Reynolds, Matthew, et al. ``Using Discrete Event Simulation to Design a More Efficient Hospital Pharmacy for Outpatients.” \textit{Health Care Management Science}, vol. 14, no. 3, 2011, pp. 223–236., doi:10.1007/s10729-011-9151-1.
\bibitem{Discrete} Reynolds, Matthew, et al. ``Using Discrete Event Simulation to Design a More Efficient Hospital Pharmacy for Outpatients.” \textit{Health Care Management Science}, vol. 14, no. 3, 2011, pp. 223–236., doi:10.1007/s10729-011-9151-1.
\end{thebibliography}
